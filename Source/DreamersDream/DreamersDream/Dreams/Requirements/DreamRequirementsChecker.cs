...
namespace DreamersDream
{
    ...
    {
        public static bool HasBackstory(this BackstoryCategory backstoryCategory, Pawn pawn, bool checksForOpposite)
        {
        ...
        internal static bool CheckRequirementForPawn(this DreamDef dream, Pawn pawn)
        {
            ...
            {
                if (!req.HasBackstory(pawn, false))
                {
                    flag = false;
                    //Log.Message("22");
                }
